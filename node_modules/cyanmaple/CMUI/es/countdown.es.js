...
var script = {
    ...
    selfTime: function selfTime(value) {
      if (this.endTime && this.nowTime) {
        ...
        if (countDownTime < 0) {
          ...
          this.contentList = _.mapValues(obj, function (item) {
            return _.padStart(item, 2, 0);
          });
        }
      }
    },
  ...
  mounted: function mounted() {
    ...
    if (_.isNumber(this.endTime) && _.isNumber(this.selfTime) && this.endTime > this.selfTime) {
      vm.selfTime += intervalTime;
      this.timer = setInterval(function () {
        vm.selfTime += intervalTime;
      }, intervalTime);
...
var css_248z = ".countdown-container[data-v-14471999]{background-color:#232323;color:#fff;position:relative}.countdown-container[data-v-14471999]:not(:last-child){margin-right:10px}.countdown-container[data-v-14471999]:not(:last-child):after{content:\":\";color:#232323;position:absolute;left:111%;top:0}";
...
__vue_render__._withStripped = true;
  ...
  /* scoped */
  const __vue_scope_id__ = "data-v-14471999";
  /* module identifier */
