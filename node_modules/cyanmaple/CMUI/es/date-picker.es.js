  ...
  computed: {
    ...
    noPaddingbFrom: function noPaddingbFrom() {
      var itemLen = this.$slots.default.filter(function (item) {
        return _.get(item, 'componentOptions.tag') === 'cmui-list-item';
      }).length;
      var col = _.isArray(this.realCol) ? this.realCol.length : this.realCol;
...
var css_248z$1 = ".cmui-list-item{float:left;position:relative;min-height:1px;width:100%}.cmui-list-item-title{position:-webkit-sticky;position:sticky;top:0;z-index:20}";
...
var script$3 = {
  ...
  components: {
    cmuiList: __vue_component__$1,
    cmuiListItem: __vue_component__$2,
  ...
  computed: {
    yearList: function yearList() {
      ...
      return _.times(this.to - this.from, function (index) {
    ...
    dayList: function dayList() {
      ...
      return _.times(42, function (index) {
...
__vue_component__$3.install = function (Vue, Maple) {
