...
var script$1 = {
  ...
  argumentsRole: function argumentsRole(options, args, CURRENT) {
    if (args.length > 1) {
      options.okFn = _$1__default.filter(args, _$1__default.isFunction)[0];
      options.callback = _$1__default.filter(args, _$1__default.isFunction)[1];

      var stringList = _$1__default.filter(args, function (item) {
        return _typeof(item).match(/string|number|boolean/);
      }).map(function (item) {
        return item.toString();
      });

      options.content = _$1__default.last(stringList);
      ...
      } else if (_$1__default.isObject(args[0])) {
        options = args[0];
      } else {
        return CURRENT;
      }
...
function dialogInstall(Component) {
  ...
  var defaultsOptions = _$1__default.mapValues(props, function (item) {
    return _$1__default.isFunction(item.default) ? item.default() : item.default;
  });

  var timeHandle;

  var id = "".concat(name, "-") + _$1__default.uniqueId();

  var CURRENT = null;

  var setCurrent = _$1__default.once(function (Vue) {
  ...
  Component.install = function (Vue, Maple) {
    ...
    function dialog() {
      ...
      options = _$1__default.defaults(_$1__default.find(arguments, _$1__default.isPlainObject), options, defaultsOptions);

      _$1__default.forEach(options, function (value, key) {
        CURRENT[key] = value;
      });
...
var script$2 = {
  ...
  mounted: function mounted() {
    this.init();
    this.throttledScrollHandler = _$1__default.throttle(this.onScroll, 300);
...
var script$3 = {
  ...
  argumentsRole: function argumentsRole(options, args, CURRENT) {
    ...
    if (args.length > 1) {
      var fnList = _$1__default.filter(args, _$1__default.isFunction);

      options.selectFn = fnList[0];
      options.cancelFn = fnList[1];

      var styleList = _$1__default.filter(args, _$1__default.isPlainObject);
      ...
      stringList.forEach(function (item, index) {
        ...
        var style = _$1__default.get(styleList, index);
      ...
      var arrArg = _$1__default.find(args, _$1__default.isArray);
      ...
      } else if (_$1__default.isArray(args[0])) {
        options.items = args[0];
      } else if (_$1__default.isFunction(args[0])) {
  ...
  methods: {
    cancel: function cancel() {
      ...
      _$1__default.isFunction(this.cancelFn) && this.cancelFn();
    },
    itemEvent: function itemEvent(item, index) {
      this.selfVisible = false;
      this.$emit('select', item, index, this);
      _$1__default.isFunction(this.selectFn) && this.selectFn(item, index);
    },
    getActionText: function getActionText(value, index) {
      if (_$1__default.isFunction(value)) {
        return this.getActionText(value());
      } else if (_$1__default.isObject(value)) {
    ...
    getActionStyle: function getActionStyle(itemStyle, baseStyle) {
      return _$1__default.defaults(itemStyle, baseStyle);
    }
  }
};
...
var script$5 = {
  ...
  argumentsRole: function argumentsRole(options, args, CURRENT) {
    if (args.length > 1) {
      options.callback = _$1__default.filter(args, _$1__default.isFunction)[0];
      ...
      if (stringList.length > 1) {
        options.timeout = _$1__default.last(_$1__default.filter(args, _$1__default.isNumber)) | 0;
      }
    } else {
      if (_typeof(args[0]).match(/string|number|boolean/)) {
        options.content = args[0];
...
var basemixin = {
  methods: {
    ...
    getParent: function getParent(componentName) {
      ...
      while (_$1__default.get(parent, '$options._componentTag') !== componentName) {
        parent = _$1__default.get(parent, '$parent');
...
var script$9 = {
  ...
  data: function data() {
    ...
    return {
      name: _$1__default.findIndex(this.$parent.$children, function (item) {
        return item === _this;
      })
    };
  },
...
var script$a = {
    ...
    selfTime: function selfTime(value) {
      if (this.endTime && this.nowTime) {
        ...
        if (countDownTime < 0) {
          ...
          this.contentList = _$1__default.mapValues(obj, function (item) {
            return _$1__default.padStart(item, 2, 0);
          });
        }
      }
    },
  ...
  mounted: function mounted() {
    ...
    if (_$1__default.isNumber(this.endTime) && _$1__default.isNumber(this.selfTime) && this.endTime > this.selfTime) {
      vm.selfTime += intervalTime;
      this.timer = setInterval(function () {
        vm.selfTime += intervalTime;
      }, intervalTime);
...
var script$b = {
  ...
  computed: {
    ...
    positionClass: function positionClass() {
      if (_$1__default.includes(this.targetClass.split(' '), 'center')) {
        return '';
      } else if (_$1__default.includes(this.targetClass.split(' '), 'bottom')) {
        return 'bottom';
      } else {
        return 'top';
      }
...
function formatWheelData(wheelData, lengthStore) {
  lengthStore.maxLen = _$1__default.max([lengthStore.maxLen, lengthStore.tempLen]);
  return _$1__default.map(wheelData, function (item) {
    if (_$1__default.isPlainObject(item)) {
      if (_$1__default.isArray(item.children) && item.children.length) {
        lengthStore.tempLen++;
...
function formatData(data) {
  ...
  return _$1__default.map(data, function (whleeData, index) {
    return formatWheelData(whleeData, _$1__default.assign(lengthStore, {
      tempLen: index + 1
    }));
  }).concat(_$1__default.fill(Array(lengthStore.maxLen - data.length), [{
    text: '',
    value: undefined
  }]));
}
...
function getInitData(data, value) {
  console.log('innit');
  var pickerData = formatData(_$1__default.every(data, _$1__default.isArray) ? data : [data]);
  var valueList = _$1__default.isArray(value) ? value : [value];
  ...
  var _loop = function _loop(index) {
    ...
    var activeIndex = _$1__default.findIndex(item, function (item) {
      return _$1__default.isEqual(item.value, valueList[index]);
    });

    activeIndex = ~activeIndex ? activeIndex : 0;
    pickerSelectIndex[index] = activeIndex;

    var chiildrenData = _$1__default.get(item, "[".concat(activeIndex, "].children"));
...
var script$d = {
  ...
  argumentsRole: function argumentsRole(options, args) {
    options.title = _$1__default.find(args, _$1__default.isString);
    options.data = _$1__default.find(args, _$1__default.isArray);
    options.rightFn = _$1__default.find(args, _$1__default.isFunction);
    options.leftFn = _$1__default.filter(args, _$1__default.isFunction)[1];
  },
  components: {
    cmuiPopup: __vue_component__
  },
      ...
      set: function set(value) {
        ...
        if (value && !this.wheels.length) {
          this.$nextTick(function () {
            _$1__default.forEach(_this2.pickerData, function (item, index) {
  ...
  methods: {
    ...
    updateData: function updateData(index, active) {
      ...
      var children = _$1__default.get(this, "pickerData[".concat(index, "][").concat(active, "].children"));

      if (children) {
        if (!_$1__default.isEqual(this.pickerData[index + 1], children)) {
    ...
    destroyWheels: function destroyWheels() {
      _$1__default.forEach(this.wheels, function (item) {
    ...
    getData: function getData() {
      ...
      return _$1__default.map(this.wheels, function (item, index) {
        return {
    ...
    setData: function setData(data) {
      ...
      _$1__default.delay(function () {
        _this4.destroyWheels();

        _$1__default.assign(_this4, getInitData(data, _this4.value));

        _this4.$nextTick(function () {
          _$1__default.forEach(_this4.pickerData, function (item, index) {
    ...
    _ok: function _ok() {
      ...
      if (_$1__default.isFunction(this.rightFn)) {
      ...
      this.$emit('input', _$1__default.isArray(this.value) ? data.map(function (item) {
        return item.value;
    ...
    _cancel: function _cancel() {
      if (_$1__default.isFunction(this.leftFn)) {
...
function formateData(data) {
  if (!_$1__default.isArray(data)) {
    return [];
  } else {
    return data.map(function (item) {
      if (_$1__default.isPlainObject(item)) {
        return _$1__default.defaults(item, {
          text: '',
          value: undefined
        });
      } else {
...
var script$f = {
  ...
  methods: {
    changeNumber: function changeNumber() {
      ...
      targetValue = _$1__default.min([this.max, targetValue]);
      targetValue = _$1__default.max([this.min, targetValue]);

      if (_$1__default.isFunction(beforeChangeEvent)) {
  ...
  computed: {
    model: {
      get: function get() {
        ...
        if (_$1__default.isArray(value)) {
          var allTrue = _$1__default.every(this.value, function (item) {
            return (_$1__default.isObject(item) ? _$1__default.get(item, _this.path) : item) === true;
          });

          var allFalse = _$1__default.every(this.value, function (item) {
            return (_$1__default.isObject(item) ? _$1__default.get(item, _this.path) : item) === false;
          });
      ...
      set: function set(value) {
        if (this.inGroup) {
          ...
          this.isExceedLimit = !_$1__default.inRange(value.length, min - 1, max + 1);
    ...
    selfValue: function selfValue() {
      ...
      return value ? _$1__default.isPlainObject(value) && value.value ? value.value : value : label || this.label;
    },
    selfLabel: function selfLabel() {
      ...
      return _$1__default.isPlainObject(value) && value.label ? value.label : label || this.label;
    },
    ...
    isChecked: function isChecked() {
      if (_$1__default.isBoolean(this.model)) {
        return this.model;
      } else if (_$1__default.isArray(this.model)) {
        return _$1__default.includes(this.model, this.label);
      }
    ...
    handleChange: function handleChange(event) {
      ...
      if (_$1__default.isFunction(beforeChangeEvent)) {
        ...
        new Promise(function (resolve, reject) {
          ...
          if (_$1__default.isArray(_this2.value)) {
            var length = _this2.value.length;

            if (_$1__default.every(_this2.value, _$1__default.isBoolean)) {
              _this2.value = new Array(length).fill(value);
            } else {
              _$1__default.forEach(_this2.value, function (item) {
                _$1__default.set(item, _this2.path, value);
              });
            }
          }
        ...
        if (_$1__default.isArray(this.value)) {
          var length = this.value.length;

          if (_$1__default.every(this.value, _$1__default.isBoolean)) {
            this.$emit('input', new Array(length).fill(value), this);
          } else {
            this.value.forEach(function (item) {
              return _$1__default.set(item, _this2.path, value);
            });
          }
        } else {
          this.$emit('input', value, this);
...
var script$h = {
  ...
  computed: {
    isBtn: function isBtn() {
      return _$1__default.includes(this.targetClass, 'btn');
    }
  },
  watch: {
    value: function value(_value) {
...
var script$k = {
  ...
  methods: {
    ...
    removeField: function removeField(field) {
      _$1__default.remove(this.fields, function (item) {
        return item === field;
      });
    },
    ...
    validate: function validate(callback) {
      ...
      this.fields.forEach(function (field) {
        field.validate('', function (message, field) {
          ...
          invalidFields = _$1__default.assign({}, invalidFields, field);
  ...
  methods: {
    ...
    getFilteredRule: function getFilteredRule(trigger) {
      ...
      return rules.filter(function (rule) {
        ...
        return _$1__default.assign({}, rule);
      });
    },
...
sliderMethodsList.forEach(function (item) {
  SliderList.prototype[item] = function (arg) {
    ...
    _$1__default.times(this.length).forEach(function (index) {
...
sliderPropsList.forEach(function (item) {
  SliderList.prototype[item] = function () {
    return _$1__default.get(this, '[0]' + item);
  };
});
...
SliderList.prototype.remove = function () {
  ...
  _$1__default.times(this.length, function (index) {
    var swiper = _this2[index];

    if (swiper instanceof Swiper) {
      var container = swiper.container;

      var baseIndex = _$1__default.findKey(sliderList, swiper);
...
function optionsMaker(options, themeName) {
  ...
  var themeOptions = _$1__default.get(themeList, themeName);
  ...
  var rsOptions = _$1__default.defaultsDeep(options, propOptions, themeOptions);
...
var sliderObserve = new ( /*#__PURE__*/function () {
  ...
  _createClass(_class, [{
    ...
    value: function observeControl(vm) {
      ...
      if (controlName && _$1__default.isString(controlName)) {
      ...
      var refName = _$1__default.get(vm, '$vnode.data.ref');
...
var script$n = {
  ...
  props: {
    id: {
      type: String,
      default: _$1__default.uniqueId('cmui-slider_'),
      intro: '默认ID'
    },
    watch: {
      type: [Object, Array],
  ...
  watch: {
    watch: {
      ...
      handler: function handler(newValue, oldValue) {
        if (this.loop) {
          _$1__default.differenceWith(newValue, oldValue, _$1__default.isEqual).length && this.resetSwiper();
        } else {
          !_$1__default.isEqual(newValue, oldValue) && this.resetSwiper();
        }
      }
    },
    options: {
      ...
      handler: function handler(newOptions, oldOptions) {
        if (!_$1__default.isEqual(newOptions, oldOptions)) {
          this.resetSwiper();
        }
      }
    }
...
function ImagePreView(ImageList) {
  ...
  var id = _$1__default.uniqueId('preView_');
  ...
  return new Vue({
    ...
    methods: {
      preViewListClick: function preViewListClick(event) {
        ...
        if (!_$1__default.includes(_$1__default.get(event, 'target.classList'), 'swiper-pagination-bullet') && _$1__default.get(this, '$children[0]')) {
...
var checkLazyLoadImage = _$1__default.debounce(function () {
  if (checkFinish) {
    checkFinish = false;
...
var script$p = {
  ...
  destroyed: function destroyed() {
    _$1__default.remove(lazyLoadList, this);
  },
  methods: {
...
var script$q = {
  ...
  computed: {
    ...
    realCol: function realCol() {
      ...
      if (_$1__default.isNumber(value)) {
        if (_$1__default.inRange(value, 0, 11)) {
          return parseInt(value) || 1;
        } else {
          return 1;
        }
      } else if (_$1__default.isArray(value) && _$1__default.every(value, _$1__default.isNumber)) {
    ...
    noPaddingbFrom: function noPaddingbFrom() {
      var itemLen = this.$slots.default.filter(function (item) {
        return _$1__default.get(item, 'componentOptions.tag') === 'cmui-list-item';
      }).length;
      var col = _$1__default.isArray(this.realCol) ? this.realCol.length : this.realCol;
  ...
  mounted: function mounted() {
    ...
    document.addEventListener('scroll', _$1__default.throttle(function () {
  ...
  methods: {
    indexFormat: function indexFormat(value) {
      if (_$1__default.isFunction(this.index)) {
...
var script$r = {
  ...
  destroyed: function destroyed() {
    _$1__default.remove(this.bus.children, this);
  },
  methods: {
    itemStyle: function itemStyle() {
      var width;
      var col = this.bus.parent.realCol;
      var colCount = (_$1__default.isArray(col) ? col.length : col) || 1;
      ...
      if (_$1__default.isNumber(col) && col !== 1) {
        width = 100 / col + '%';
      } else if (_$1__default.isArray(col)) {
...
var script$s = {
  ...
  destroyed: function destroyed() {
    ...
    if (parent.index) {
      _$1__default.remove(parent.groupList, function (item) {
...
var script$u = {
  ...
  computed: {
    yearList: function yearList() {
      ...
      return _$1__default.times(this.to - this.from, function (index) {
    ...
    dayList: function dayList() {
      ...
      return _$1__default.times(42, function (index) {
...
var script$v = {
  ...
  methodName: 'mask',
  argumentsRole: function argumentsRole(options, args, CURRENT) {
    var argString = _$1__default.filter(args, _$1__default.isString);

    options.position = _$1__default.find(argString, function (item) {
      return _$1__default.every(item.split(' ').filter(function (i) {
        return i.length;
      }), function (i) {
        return /^(top|left|bottom|right|center|between)$/.test(i);
      });
    });
    options.content = _$1__default.find(argString, function (item) {
      return item !== options.position;
    });
    options.callback = _$1__default.find(args, _$1__default.isFunction);
  },
  props: {
    position: {
      type: String,
...
function setDisFromValue(value) {
  ...
  dis = _$1__default.max([dis, 0]);
  dis = _$1__default.min([dis, barInfo.width - dotInfo.width]);
  this.transDisX = dis;
}
...
var script$w = {
  ...
  methods: {
    ...
    moveHandle: function moveHandle(e) {
      ...
      dis = _$1__default.min([dis, this.barInfo.width - this.dotInfo.width]);
      dis = _$1__default.max([dis, 0]);
      ...
      _this.swiper = new Swiper(container, {
        ...
        on: {
          ...
          touchEnd: function touchEnd() {
            ...
            _$1__default.delay(_this.resetPull);
          }
        }
      });
    ...
    updatePull: function updatePull(progress, translate, endHandel) {
      ...
      if (progress < 0) {
        if (translate > this.pullDis) {
          this.pullStartText = _$1__default.get(this.pullText, 1);
          endHandel && this.$emit('pullStart', this);
        } else {
          this.pullStartText = _$1__default.get(this.pullText, 0);
        }

        var dis = parseInt(_$1__default.min([translate - 20, 10]));
        ...
        if (translate * (progress - 1) * -1 - 20 > this.pullDis) {
          this.pullEndText = _$1__default.get(this.pullText, 3);
          endHandel && this.$emit('pullEnd', this);
        } else {
          this.pullEndText = _$1__default.get(this.pullText, 2);
        }

        var _dis = _$1__default.min([translate * (progress - 1) * -1 - 20, 10]) * -1;
...
var script$y = {
  ...
  data: function data() {
    ...
    if (_$1__default.get(parent, 'direction') === 'v' && _$1__default.get(parent, 'col') === 'auto') {
...
var script$z = {
  ...
  methods: {
    handleTouchStart: function handleTouchStart(e) {
      ...
      _$1__default.forEach(openedList, function (item) {
    ...
    close: function close() {
      ...
      _$1__default.remove(openedList, function (item) {
        return item === _this5;
      });
    }
  }
...
function scrollTo(target) {
  ...
  if (_$1__default.isNumber(top)) {
    var domPos = dom.scrollTop;

    if (Math.abs(top - domPos) <= 3 || !animate) {
      dom.scrollTop = top;
      _$1__default.isFunction(callback) && callback();
    } else {
      var t = dom.scrollTop;
...
function scrollBar () {
  ...
  var dom = _$1__default.remove(arg, _$1__default.isElement)[0] || document.documentElement;

  var animate = _$1__default.remove(arg, _$1__default.isBoolean)[0];

  var callback = _$1__default.remove(arg, _$1__default.isFunction)[0];
...
var contentScrollEvent = _$1__default.throttle(function (e) {
  ...
  if (this.isVertical) {
    ...
    switch (e.target) {
      case this.$refs.content:
        var findIndex = _$1__default.findLastIndex(this.$refs.content.childNodes, function (item) {
    ...
    var _findIndex = _$1__default.findLastIndex(this.$refs.content.childNodes, function (item) {
...
var script$B = {
  ...
  computed: {
    ...
    itemStyle: function itemStyle() {
      ...
      if (_$1__default.isNumber(this.col)) {
    ...
    isVertical: function isVertical() {
      return _$1__default.includes(['left', 'right'], this.position);
    },
    ...
    showPreNav: function showPreNav() {
      return !!_$1__default.get(this.nav, '[0]');
    },
    showNextNav: function showNextNav() {
      return !!_$1__default.get(this.nav, '[1]');
    },
  ...
  methods: {
    scrollAcitveIntoViewIfNeeded: function scrollAcitveIntoViewIfNeeded() {
      ...
      if (!_$1__default.inRange(activeItemP[pos[0]], tabBarP[pos[0]], tabBarP[pos[1]])) {
    ...
    changeToIndex: function changeToIndex() {
      ...
      if (_$1__default.inRange(index, this.items.length)) {
        var _this = this;
    ...
    changeByStep: function changeByStep() {
      ...
      if (_$1__default.inRange(this.activeIndex + num, this.items.length)) {
        this.activeIndex += num;
        this.changeToIndex(this.activeIndex);
      }
    },
    getItems: function getItems() {
      return _$1__default.filter(this.$slots.default, function (item) {
    ...
    update: function update() {
      ...
      if (this.$slots.default) {
        var items = _$1__default.filter(this.$slots.default, function (vnode) {
          return _$1__default.get(vnode, 'componentOptions.Ctor.options.name') === 'cmui-tabbar-item';
        }).map(function (_ref) {
  ...
  render: function render(h) {
    ...
    var extraList = extras.map(function (item, index) {
      return h('div', {
        ...
        key: index,
        on: {
          click: _$1__default.partialRight(extraEvent, item, index)
        }
      }, [item]);
    });
    var extra = h('div', {
    ...
    }, _$1__default.includes(['right', 'bottom'], position) ? [content, head] : [head, content]);
  }
};
...
var script$F = {
  ...
  beforeDestroy: function beforeDestroy() {
    ...
    _$1__default.remove(this.cmuiScreen.children, this);
  },
  methods: {
    active: function active() {
      this.actived = true;
...
var script$G = {
  ...
  methods: {
    setTitle: function setTitle() {
      ...
      if (this.$slots.default) {
        var items = _$1__default.filter(this.$slots.default, function (vnode) {
          return _$1__default.get(vnode, 'componentOptions.Ctor.options.name') === 'cmui-classify-item';
        }).map(function (_ref) {
          var componentInstance = _ref.componentInstance;
          return componentInstance;
        });
  ...
  render: function render(h) {
    ...
    var content = h('div', {
      ...
      ref: 'content',
      on: {
        scroll: _$1__default.throttle(function () {
          ...
          _this.index = _$1__default.findIndex(_this.$refs.content.childNodes, function (item) {
            return item.getBoundingClientRect().top > contentTop;
          }) - 1;
        }, {
          wait: 200
...
function BaseLoad(src, tagName) {
  ...
  return !src ? Promise.resolve(null) : new Promise(function (resolve, reject) {
    ...
    (function loop(props, target) {
      _$1__default.forEach(props, function (value, key) {
        _$1__default.isObject(value) ? loop(value, target[key]) : target[key] = value;
      });
    })(props, dom);
...
var ShakeHandle = /*#__PURE__*/function () {
  function ShakeHandle(options) {
    ...
    this.handleList = _$1__default.filter(options, _$1__default.isFunction);
...
function shake() {
  var options = {
    startFn: _$1__default.filter(arguments, _$1__default.isFunction)[0] || function () {},
    endFn: _$1__default.filter(arguments, _$1__default.isFunction)[1] || function () {},
    interval: _$1__default.filter(arguments, _$1__default.isNumber)[0] || 0,
    // 每次触发startFn的时间间隔
    continueEvent: _$1__default.filter(arguments, _$1__default.isBoolean)[0] || true // 摇动过程中是否持续执行startFn事件

  };

  _$1__default.assign(options, _$1__default.find(arguments, _$1__default.isPlainObject));

  if (!options.continueEvent) {
    options.hasRun = false;
  } else if (options.interval > 16) {
    // 针对16毫秒的时差做兼容
    options.startFn = _$1__default.throttle(options.startFn, options.interval, {
      trailing: false
    });
  }
...
ready(function () {
  ...
  cssRules = _$1__default.get(cmuiStyle, 'sheet.cssRules');
  cssRulesLen = cssRules.length;
});

function style() {
  if (arguments.length) {
    var argStringList = _$1__default.filter(arguments, _$1__default.isString);

    var selector = _$1__default.get(argStringList, 0);

    var name = _$1__default.camelCase(_$1__default.get(argStringList, 1)) || undefined;

    var value = _$1__default.get(argStringList, 2);

    value = _$1__default.find(arguments, _$1__default.isPlainObject) || value;

    if (selector && name && value) {
      // 设置样式
      if (_$1__default.isString(value)) {
        var matchRule = _$1__default.findLast(cssRules, function (item) {
          return _$1__default.get(item, 'selectorText') === selector;
        });
      ...
      if (value === undefined) {
        // 读取样式
        var t = _$1__default.findLast(cssRules, function (item) {
          return _$1__default.get(item, 'selectorText') === selector;
        });

        return _$1__default.get(t, "style[".concat(name, "]"));
      } else {
        // 删除选择器下的具体样式
        var _t = _$1__default.findLast(cssRules, function (item) {
          return _$1__default.get(item, 'selectorText') === selector;
        });

        _t = _$1__default.get(_t, 'style');
        delete _t[name];
      }
    } else if (selector && _$1__default.isPlainObject(value)) {
      _$1__default.forEach(value, function (value, key) {
        style(selector, key, value);
      });
    } else if (selector) {
      // 读取样式
      if (name === '' || value === '') ; else {
        var tempStyle = _$1__default.findLast(cssRules, function (item) {
          return _$1__default.get(item, 'selectorText') === selector;
        });

        tempStyle = _$1__default.get(tempStyle, 'style');

        var arr = _$1__default.filter(tempStyle, function (item) {
          return item;
        });

        return _$1__default.pick(tempStyle, arr);
      }
    }
  }
...
Url.prototype.replaceHash = function () {
  ...
  _$1__default.forEach(args, function (item) {
    switch (_typeof(item)) {
      case 'string':
  ...
  _$1__default.forEach(this.route.params, function (value, key) {
...
function fullScreen() {
  ...
  if (_$1__default.isBoolean(element)) {
    element ? enterFullScreen() : exitFullScreen();
  } else if (_$1__default.isElement(element)) {
...
function read(s, converter) {
  ...
  return _$1.isFunction(converter) ? converter(value) : value;
}

var config = function config(key, value, options) {
  // Write
  if (value !== undefined && !_$1.isFunction(value)) {
...
var cookie = function cookie() {
  if (arguments[2] && _$1.isObject(arguments[2])) {
...
var localData = function localData() {
  ...
  if (!length) {
    ...
    if (_$1.isObject(arguments[0]) && isTimeStr(arguments[1])) {
...
var install = function install(Vue) {
  ...
  _$1__default.forEach(components$1, function (component) {
    return component.install(Vue, Maple);
  });

  _$1__default.forEach(components$2, function (component) {
    return component.install(Vue);
  });

  _$1__default.assign(Maple, methods);
};
...
var index$1 = _$1__default.assign({}, {
  install: install
}, components$1);
