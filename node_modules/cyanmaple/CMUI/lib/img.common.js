...
function optionsMaker(options, themeName) {
  ...
  var themeOptions = _.get(themeList, themeName);
  ...
  var rsOptions = _.defaultsDeep(options, propOptions, themeOptions);
...
var sliderObserve = new ( /*#__PURE__*/function () {
  ...
  _createClass(_class, [{
    ...
    value: function observeControl(vm) {
      ...
      var refName = _.get(vm, '$vnode.data.ref');
...
var script = {
  ...
  props: {
    id: {
      type: String,
      default: _.uniqueId('cmui-slider_'),
      intro: '默认ID'
    },
    watch: {
      type: [Object, Array],
...
var css_248z = ".swiper-scrollbar:empty{display:none}";
...
function ImagePreView(ImageList) {
  ...
  return new Vue({
    components: {
      cmuiSlider: __vue_component__,
      cmuiSliderItem: __vue_component__$1
    },
    data: {
...
var css_248z$1 = ".fade-enter-active,.fade-leave-active{-webkit-transition:opacity .5s;transition:opacity .5s}.fade-enter,.fade-leave-to{opacity:0}.slide-enter-active,.slide-leave-active{-webkit-transition:all .5s;transition:all .5s}.slide-enter,.slide-leave-to{-webkit-transform:translateY(100%);transform:translateY(100%);opacity:0}";
